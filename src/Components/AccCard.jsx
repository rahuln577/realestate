...
export default function AccCard(props)
{
    ...
    return <div className="flex flex-col w-[18rem] my-2 items-center gap-2">
        ...
        <img src={props.img} loading="lazy" alt="Loading..." className="flex items-center justify-center max-w-[20rem] min-w-[20rem] min-h-[15rem] max-h-[15rem]"></img>
        <h1 className="text-[1rem] text-center p-2">{props.title.slice(0,30)+" .."}</h1>
        </div>
