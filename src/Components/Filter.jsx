...
export default function Filter() {
    ...
    return <form onSubmit={handlesub} className="lg:block hidden shadow-xl rounded-lg w-[30%] h-[33rem] py-4 sticky top-[17%] left-4 mb-[3rem] z-[0]">
        ...
        <div className='w-[90%] mx-auto my-[2rem]'>
            ...
            <div className='flex justify-center my-[0.5rem]'><input type="submit" className='cursor-pointer px-[1.5rem] py-2 border-[0.1rem] border-blue-400' value="Filter"></input></div>
        </div>
    </form>
}