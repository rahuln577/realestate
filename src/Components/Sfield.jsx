...
{
 return <div className='shadow-2xl bg-white rounded-lg lg:h-[25rem] min-h-[23rem] w-[85%] lg:w-[35%] lg:mt-[8%]'>
    ...
    <div className="flex flex-col justify-between h-[70%] items-center mt-6">
        <input type="text" placeholder="Bengaluru,Chennai,etc." className="bg-slate-100 w-[90%] h-[3rem] rounded-xl p-4"></input>
        <select  className="bg-slate-100 w-[90%] h-[3rem] rounded-xl p-3">
            <option value="" disabled selected><p className="text-slate-400">Select Property type</p></option>
            <option value="House">House</option>
            <option value="Garage">Garage</option>
        </select>
        <select default="Bengaluru,Chennai,etc." className="bg-slate-100 w-[90%] h-[3rem] rounded-xl p-3">
            <option value="House">House</option>
            <option value="Garage">Garage</option>
        </select>
